...
global $show_calendar, $gallery, $video, $trascrizione, $luogo, $appuntamento, $inline;
			...
			<div class="row">
				<div class="col-lg-8 px-lg-4 py-lg-2">
					...
					<?php if ( $start_timestamp && $end_timestamp ) { ?>
						<h2 class="h4 py-2" data-audio>dal
				...
				<section class="col-lg-9 it-page-sections-container border-light">
					...
					<?php if ( $start_timestamp && $end_timestamp ) { ?>
						<article id="date-e-orari" class="it-page-section mb-5">
							...
							<div class="point-list-wrapper my-4">
								<div class="point-list">
									<h3 class="point-list-aside point-list-primary fw-normal">
										<span class="point-date font-monospace">
											<?php echo $start_date_arr[0]; ?>
										</span>
										<span class="point-month font-monospace">
								...
								<div class="point-list">
									<h3 class="point-list-aside point-list-primary fw-normal">
										<div class="point-date font-monospace">
											<?php echo $end_date_arr[0]; ?>
										</div>
										<div class="point-month font-monospace">
											<?php echo $end_date_arr[1]; ?>
										</div>
									</h3>
									<div class="point-list-content">
										<div class="card card-teaser shadow rounded">
											<div class="card-body">
												<h3 class="card-title h5 m-0">
													<?php echo $end_date_arr[3]; ?>:
													<?php echo $end_date_arr[4]; ?> - Fine evento
												</h3>
											</div>
										</div>
									</div>
							...
							<p class="font-serif">
								Per informazioni sul programma dettagliato degli appuntamenti religiosi e civili, consultare il
								programma
							...
							<div class="card card-teaser shadow mt-3 rounded">
								<div class="card-body">
									<h3 class="card-title h5 m-0">
										...
										<a class="text-decoration-none" href="<?php echo $allegati; ?>"

...
global $obj, $the_query, $load_posts, $load_card_type, $additional_filter, $title, $description, $data_element, $hide_categories;
...
$amministrazione = dci_get_related_unita_amministrative($obj->slug);
                            ...
                            <div class="cmp-input-search">
                                <div class="form-group autocomplete-wrapper mb-2 mb-lg-4">
                                    <div class="input-group">
                                        <label for="autocomplete-two" class="visually-hidden">Cerca una parola
                                            chiave</label>
                                        <input type="search"
                                    ...
                                    <ul class="link-list t-primary">
                                        ...
                                        <li>
                                            <a class="list-item ps-0 text-button-xs-bold d-flex align-items-center text-decoration-none"
                                               href="<?php echo get_permalink( get_page_by_path( 'amministrazione' ) ); ?>">

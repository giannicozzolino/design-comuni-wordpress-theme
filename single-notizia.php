										...
										<div class="card-body">
											<h5 class="card-title">
												<a class="text-decoration-none" href="<?php echo get_permalink( $doc_id ); ?>"
													...
													title="Visualizza il documento <?php echo $documento->post_title; ?>">
							...
							<div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
								<?php foreach ( $datasets as $dataset_id ) {
									...
									<div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
										...
										<div class="card-body">
											<h5 class="card-title">
												<a class="text-decoration-none" href="<?php echo get_permalink( $dataset_id ); ?>"
													aria-label="Visualizza il dataset <?php echo $dataset->post_title; ?>"
													title="Visualizza il dataset <?php echo $dataset->post_title; ?>">
					...
					<article class="it-page-section anchor-offset mt-5">
						...
						<div class="row">
							<div class="col-12 col-sm-8">
								...
								<?php foreach ( $a_cura_di as $post_id ) {
									$with_border = true;

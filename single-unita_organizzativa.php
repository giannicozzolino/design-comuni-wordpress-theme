		...
		<div class="container">
			<div class="row border-top row-column-border row-column-menu-left border-light">
												...
												<div id="collapse-one" class="accordion-collapse collapse show"
													...
													<div class="accordion-body">
														<ul class="link-list" data-element="page-index">
															...
															<?php } ?>
															<?php if ( $tipo_organizzazione && is_array( $tipo_organizzazione ) && count( $tipo_organizzazione ) > 0 ) { ?>
																<li class="nav-item">
																	<a class="nav-link" href="#tipo-uo">
																		<span class="title-medium">Tipo di unità
																			organizzativa</span>
																	</a>
																</li>
															<?php } ?>
															<?php if ( $unita_organizzativa_genitore && is_array( $unita_organizzativa_genitore ) && count( $unita_organizzativa_genitore ) > 0 ) { ?>
																<li class="nav-item">
				...
				<article class="col-lg-9 it-page-sections-container border-light">
					<section class="it-page-section mb-5" id="competenze">
					...
					<section class="it-page-section mb-5" id="tipo-uo">
						<h2 class="mb-3">Tipo di unità organizzativa</h2>
					...
					<?php if ( $unita_organizzativa_genitore ) { ?>
						<section class="it-page-section mb-5" id="area">
					...
					<?php if ( $responsabili && is_array( $responsabili ) && count( $responsabili ) ) { ?>
						<section class="it-page-section mb-5" id="responsabile">
					...
					<?php if ( is_array( $persone ) && count( $persone ) ) { ?>
						<section class="it-page-section mb-5" id="persone">
					...
					<?php if ( $servizi && is_array( $servizi ) && count( $servizi ) ) { ?>
						<section class="it-page-section mb-5" id="servizi">
							<h2 class="mb-3">Servizi offerti</h2>
					...
					<section class="it-page-section mb-5" id="sede-principale">
					...
					<?php if ( $altre_sedi && is_array( $altre_sedi ) && count( $altre_sedi ) ) { ?>
						<section class="it-page-section mb-5" id="altre-sedi">
